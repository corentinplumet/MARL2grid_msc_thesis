...
if [[ "${1:-}" == "--help" || "${1:-}" == "-h" ]]; then
  cat <<'EOF'
Usage: sbatch run_jobs/job_izar.sh [preset] [main.py args...]
...
Examples:
  ...
  sbatch run_jobs/job_izar.sh qplex14 --seed 2 --track true
  ...
  sbatch run_jobs/job_izar.sh --env-id bus14 --alg MAPPO --seed 0
  ...
  sbatch run_jobs/job_izar.sh mappo14_fast_noheuristic --seed 0
  ...
  Run one seed-0 job:
    sbatch run_jobs/job_izar.sh table5_mappo14 --seed 0
    sbatch run_jobs/job_izar.sh table5_mappo14_fullobs --seed 0
    sbatch run_jobs/job_izar.sh table5_qplex14 --seed 0
    sbatch run_jobs/job_izar.sh table5_lagrmappo14_l --seed 0
    sbatch run_jobs/job_izar.sh table5_lagrmappo14_o --seed 0

  Real Table 5 presets use paper hyperparameters with 10 parallel envs and 2000 rollout steps.
  Run one seed-0 job:
    sbatch run_jobs/job_izar.sh table5_real_mappo14 --seed 0
    sbatch run_jobs/job_izar.sh table5_real_qplex14 --seed 0
    sbatch run_jobs/job_izar.sh table5_real_lagrmappo14_l --seed 0
    sbatch run_jobs/job_izar.sh table5_real_lagrmappo14_o --seed 0
