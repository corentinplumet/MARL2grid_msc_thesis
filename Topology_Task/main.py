...
def main(args: Namespace) -> None:
    ...
    idle_tag = "I" if args.heuristic_type == "idle" else ""
    ...
    run_name = args.resume_run_name if args.resume_run_name \
        else f"{args.alg}_{args.env_id}_{action_tag}_{args.seed}_{args.difficulty}_{heuristic_tag}_{idle_tag}_{constraint_tag}_{int(time())}_{np.random.randint(0, 50000)}"
