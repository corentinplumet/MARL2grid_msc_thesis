...
class MAPPO:
    ...
    def __init__(self, envs: gym.Env, run_name: str, start_time: float, args: Dict[str, Any], ckpt: CheckpointSaver):
        ...
        joint_obs_template = get_joint_obs(next_obs, args.critic_encoder, args.decentralized)
        ...
        try:
            for iteration in range(init_rollout, n_rollouts + 1):
                ...
                for step in range(0, args.n_steps):
                    ...
                    with th.no_grad():   
                        joint_obs = get_joint_obs(next_obs, args.critic_encoder, args.decentralized)
                ...
                with th.no_grad():
                    advantages, returns = {}, {}
                    joint_real_next_obs = get_joint_obs(real_next_obs, args.critic_encoder, args.decentralized)
                    for agent in agent_ids:
                ...
                for agent in agent_ids:
                    ...
                    for _ in range(args.update_epochs):
                        ...
                        for start in range(0, batch_size, minibatch_size):
                            ...
                            # Value loss
                            newvalue = critic.get_value(index_nested(b_joint_obs, mb_inds)).view(-1)
                            if args.clip_vfloss:
