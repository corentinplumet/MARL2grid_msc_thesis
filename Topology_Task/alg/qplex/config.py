...
def get_alg_args() -> Namespace:
    ...
    parser.add_argument("--learning-starts", type=int, default=10, help="When to start learning")
    ...
    parser.add_argument("--q-encoder", type=str, default="mlp", choices=["mlp", "gnn"], help="Observation encoder for per-agent Q-networks")
    parser.add_argument("--mixer-encoder", type=str, default="mlp", choices=["mlp", "gnn"], help="State encoder for the QPLEX mixer")
    ...
    parser.add_argument("--gnn-aggr", type=str, default="mean", choices=["mean", "sum"], help="GNN neighborhood aggregation")
    ...
    parser.add_argument("--gnn-graph-type", type=str, default="substation", choices=["substation", "bus"], help="Use substations or busbars as graph nodes")
    parser.add_argument("--gnn-include-neighbors", type=str2bool, default=True, help="Include one-hop neighboring substations in local agent graphs")
    ...
    # Mixer params
    parser.add_argument("--transf-embed-dim", type=int, default=256, help="Hypernet embedded dim size") 
    parser.add_argument("--n-heads", type=int, default=4, help="")  
    parser.add_argument("--mix-embed-layers", type=int, default=2, help="")
    parser.add_argument("--mix-embed-dim", type=int, default=256, help="")
    parser.add_argument('--is-minus-one', type=str2bool, default=True, help='')
    parser.add_argument('--weighted-head', type=str2bool, default=True, help='')
