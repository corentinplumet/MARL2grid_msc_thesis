...
def get_alg_args() -> Namespace:
    ...
    parser.add_argument("--n-steps", type=int, default=500, help="Steps per policy rollout")    # 20k for 1 env
    ...
    parser.add_argument("--critic-encoder", type=str, default="mlp", choices=["mlp", "gnn"], help="Observation encoder for the reward critic")
    parser.add_argument("--cost-critic-encoder", type=str, default="mlp", choices=["mlp", "gnn"], help="Observation encoder for the cost critic")
